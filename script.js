...
const translations = {
  en: {
    ...
    release: "RELEASE",
    firststable: "The first stable release of BlockChat! is available for download on Windows and Linux with basic P2P functionality.",
    ...
    secondrelease: "The second stable release of BlockChat! is available for download on Windows and Linux with advanced P2P functionality.",
  ...
  ru: {
    ...
    release: "РЕЛИЗ",
    firststable: "Первый стабильный релиз BlockChat! Доступно для скачивания на Windows и Linux с базовым P2P функционалом.",
    ...
    secondrelease: "Второй стабильный релиз BlockChat! Доступно для скачивания на Windows и Linux с расширенным P2P функционалом.",
